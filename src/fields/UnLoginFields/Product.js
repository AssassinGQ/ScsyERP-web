...
export default Object.freeze([
    ...unLoginField,
    { key: 'project', label: '所属项目', type: 'select', optionsUrl: '/BasicInfo/Project/query', nullAble: false },
    { key: 'material', label: '所属物料', type: 'select', optionsUrl: '/BasicInfo/Material/query', nullAble: false },
    { key: 'status', label: '货物状态', type: 'select', options: { 0: '待入库', 1: '已出库', 2: '已出库'}, increate: false},
    { key: 'packetNumber', label: '包号', nullAble: false },
